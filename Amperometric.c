...
AppAMPCfg_Type AppAMPCfg = 
{
  ...
  .NumOfData = -1,
  .RcalVal = 200.0,             /* Board RCAL R6 between RCAL0 and RCAL1 */
  .PwrMod = AFEPWR_LP,
  .AMPInited = bFALSE,
  .StopRequired = bFALSE,
...
static float AppAMPNominalRtiaValue(uint32_t RtiaSel)
{
  switch(RtiaSel)
  {
    case LPTIARTIA_200R: return 200.0f;
    case LPTIARTIA_1K: return 1000.0f;
    case LPTIARTIA_2K: return 2000.0f;
    case LPTIARTIA_3K: return 3000.0f;
    case LPTIARTIA_4K: return 4000.0f;
    case LPTIARTIA_6K: return 6000.0f;
    case LPTIARTIA_8K: return 8000.0f;
    case LPTIARTIA_10K: return 10000.0f;
    case LPTIARTIA_12K: return 12000.0f;
    case LPTIARTIA_16K: return 16000.0f;
    case LPTIARTIA_20K: return 20000.0f;
    case LPTIARTIA_24K: return 24000.0f;
    case LPTIARTIA_30K: return 30000.0f;
    case LPTIARTIA_32K: return 32000.0f;
    case LPTIARTIA_40K: return 40000.0f;
    case LPTIARTIA_48K: return 48000.0f;
    case LPTIARTIA_64K: return 64000.0f;
    case LPTIARTIA_85K: return 85000.0f;
    case LPTIARTIA_96K: return 96000.0f;
    case LPTIARTIA_100K: return 100000.0f;
    case LPTIARTIA_120K: return 120000.0f;
    case LPTIARTIA_128K: return 128000.0f;
    case LPTIARTIA_160K: return 160000.0f;
    case LPTIARTIA_196K: return 196000.0f;
    case LPTIARTIA_256K: return 256000.0f;
    case LPTIARTIA_512K: return 512000.0f;
    default: return 4000.0f;
  }
}

static void AppAMPEnsureValidRtia(void)
{
  if(AppAMPCfg.ExtRtia == bTRUE)
  {
    if((AppAMPCfg.ExtRtiaVal > 1.0f) && (AppAMPCfg.ExtRtiaVal < 10000000.0f))
    {
      AppAMPCfg.RtiaCalValue.Magnitude = AppAMPCfg.ExtRtiaVal;
      AppAMPCfg.RtiaCalValue.Phase = 0.0f;
      return;
    }
  }
  float mag = AppAMPCfg.RtiaCalValue.Magnitude;
  float nominal = AppAMPNominalRtiaValue(AppAMPCfg.LptiaRtiaSel);
  if((mag > nominal*0.5f) && (mag < nominal*2.0f))
    return;
  AppAMPCfg.RtiaCalValue.Magnitude = nominal;
  AppAMPCfg.RtiaCalValue.Phase = 0.0f;
}
...
AD5940Err AppAMPInit(uint32_t *pBuffer, uint32_t BufferSize)
{
  ...
  {
    AppAMPRtiaCal();
    AppAMPEnsureValidRtia();
    AppAMPCfg.ReDoRtiaCal = bFALSE;
  }else if(AppAMPCfg.ExtRtia == bTRUE)
  {
		AppAMPCfg.RtiaCalValue.Magnitude = AppAMPCfg.ExtRtiaVal;
    AppAMPEnsureValidRtia();
  }
  ...
  AD5940_INTCCfg(AFEINTC_0, AFEINTSRC_DATAFIFOTHRESH|AFEINTSRC_ENDSEQ, bTRUE);
  ...
  AD5940_SEQMmrTrig(AppAMPCfg.InitSeqInfo.SeqId);
  {
    ...
    while((AD5940_INTCTestFlag(AFEINTC_1, AFEINTSRC_ENDSEQ) == bFALSE) &&
          (AD5940_INTCTestFlag(AFEINTC_0, AFEINTSRC_ENDSEQ) == bFALSE))
    {
      AD5940_Delay10us(100); /* 1 ms */
      if(++WaitLoop > 5000)
        break;
    }
  }
